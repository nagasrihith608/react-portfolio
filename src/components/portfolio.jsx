          ...
          <div className="row">
            <div className="col-sm-12">
              <div className="title-box text-center">
                <h3 className="title-a">Project Work</h3>
                <p className="subtitle-a">
                  These are a few projects I worked on.
                </p>
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Transport System</h2>
              ...
              <div className="work-box">
                <a href={stock1} data-lightbox="gallery-aguadeluz">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Grayscale converter</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            C/C++
                          </span>{" "}
              ...
              <div className="work-box">
                <a href={stock2} data-lightbox="gallery-todo">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Hospital Management System</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            C/C++
                          </span>
              ...
              <div className="work-box">
                <a href={stock3} data-lightbox="gallery-medlingos">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">College Connect</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            Python
                          </span>
              ...
              <div className="work-box">
                <a href={stock4} data-lightbox="gallery-smth">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">Multiplayer buzzer quiz</h2>
                        <div className="w-more">
                          <span className="w-ctegory">Python</span>
                        </div>
                      </div>
              ...
              <div className="work-box">
                <a href={stock5} data-lightbox="gallery-mf">
                  ...
                  <div className="work-content">
                    <div className="row">
                      <div className="col-sm-8">
                        <h2 className="w-title">IAS Architecture</h2>
                        <div className="w-more">
                          <span className="w-ctegory">
                            C/C++
                          </span>
